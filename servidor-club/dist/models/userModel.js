...
class UserModel {
    ...
    actualizar(id, usuario, mail, password) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = (yield this.db.query('UPDATE usuarios SET nombre = ?, email = ?, password = ? WHERE ID = ?', [usuario, mail, password, id]))[0].affectedRows;
            console.log(result);
            return result;
        });
    }
